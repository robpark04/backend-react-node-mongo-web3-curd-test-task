...
const model = require('../../../helpers/constants').MONGODB.INSTANCES.NFT;
const schema = require('../../../domains/mongodb/schemas').SCHEMAS.NFT;

class NftEntity extends BaseEntityMongoDb {
